...
function Index(props) {
  ...
  useEffect(() => {
    if (Object.keys(getActionValue).length > 0) {
      selectCategory(
        { categoryId: getActionValue.categoryId },
        activeIndex,
        getActionValue.key,
        getActionValue.offset
      );
    }
  }, [getActionValue]);
  ...
  useEffect(() => {
    if (Object.keys(getActionValue1).length > 0) {
      selectCategory(
        { categoryId: getActionValue1.categoryId },
        activeIndex1,
        getActionValue1.key,
        getActionValue1.offset
      );
    }
  }, [getActionValue1]);
  ...
  const getOffer = async () => {
    ...
    if (
      getSettings &&
      getSettings.bannerFlag != localStorage.getItem("bannerFlag")
    ) {
    ...
    if (
      getSettings &&
      getSettings.frontImagesFlag != localStorage.getItem("frontImagesFlag")
    ) {
    ...
    if (
      getSettings &&
      getSettings.categoryFlag != localStorage.getItem("categoryFlag")
    ) {
    ...
    if (result && result.status == 200) {
      ...
      data = data.map((item) => {
        return Object.assign(item, {
          ...
          productRatingList: new Array(item.productRating).fill("rating"),
        });
      });
      if (key == 1) {
                ...
                parentcategory.map((item) => {
                  return (
                    <div className="col-md-4">
                      <Link href={item.link}>
                        <a
                          onClick={(e) => getVariant(item.showOn.toUpperCase())}
                        >
            ...
            <div className="row home-page-category categorybanner">
              {categoriesImage &&
                categoriesImage.map((item) => {
                  return (
                    <div className="col-md-3 mb-4 categorybox">
    ...
    return <i className="fa fa-star" aria-hidden="true"></i>
              ...
              <Slider {...carouselSetting} className="ps-carousel banner2">
                {banner3 != "" &&
                  ...
                  banner3.map((item) => {
                    return (
                      <a className="image-style" href={item.link}>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="newCollectionBox">
                    ...
                    {getLeftImage &&
                      getLeftImage.link &&
                      getLeftImage.status == 1 && (
                        <>
                          <span
                            onClick={(e) => {
                              preventDefaultLink(e, getLeftImage.link);
                            }}
                          >
                            <DisplayImageWithS3PreSignedUrl
                              imageKey={getLeftImage.imagePath}
                              resizeRequired="NO"
                            />
                          </span>
                          <Link href={getLeftImage?.link}>
                            <a title="Explore New Collection">
                              Explore <span>New Collection</span>
                            </a>
                          </Link>
                        </>
                      )}
                ...
                <div className="col-md-6">
                  <div className="flatOffBox">
                    {getRightImage &&
                      getRightImage.link &&
                      getRightImage.status == 1 && (
                        <>
                          <span
                            onClick={(e) => {
                              preventDefaultLink(e, getRightImage.link);
                            }}
                          >
                            <DisplayImageWithS3PreSignedUrl
                              imageKey={getRightImage.imagePath}
                              resizeRequired="NO"
                            />
                          </span>
                  ...
                  children={
                    <div className="">
                      {newArrivaldata.length > 0 ? (
                        <>
                          <Slider {...carouselSetting2} className="ps-carousel">
                ...
                <TabPane
                  ...
                  children={
                    <div className="">
                      {featured.length > 0 ? (
                        <>
                          <Slider {...carouselSetting3} className="ps-carousel">
                            {featured.map((item, i) => {
                              return (
                                <div key={i}>
                                  <Product
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-md-3 col-sm-12">
                  <div className="logo-header">Our Brands</div>
                </div>
